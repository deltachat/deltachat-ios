...
public class DcContext {
    ...
    public func initWebxdcIntegration(_ integrationType: Int32, for chatId: Int) -> Int {
        return Int(dc_init_webxdc_integration(contextPointer, integrationType, UInt32(chatId)))
    }
