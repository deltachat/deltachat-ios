...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    private func setStockTranslations() {
        ...
        dcContext.setStockTranslation(id: DC_STR_REMOVE_YOU_BY, localizationKey: "remove_you_by_other")
        dcContext.setStockTranslation(id: DC_STR_ADD_YOU_BY, localizationKey: "add_you_by_other")
        dcContext.setStockTranslation(id: DC_STR_REMOVE_YOU, localizationKey: "member_you_removed")
        dcContext.setStockTranslation(id: DC_STR_ADD_YOU, localizationKey: "member_you_added")
