...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    private func setStockTranslations() {
        ...
        dcContext.setStockTranslation(id: DC_STR_OUTGOING_AUDIO_CALL, localizationKey: "outgoing_audio_call")
        dcContext.setStockTranslation(id: DC_STR_OUTGOING_VIDEO_CALL, localizationKey: "outgoing_video_call")
        dcContext.setStockTranslation(id: DC_STR_INCOMING_AUDIO_CALL, localizationKey: "incoming_audio_call")
        dcContext.setStockTranslation(id: DC_STR_INCOMING_VIDEO_CALL, localizationKey: "incoming_video_call")
